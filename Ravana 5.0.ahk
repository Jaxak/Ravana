...
;~ ^numpad1:: KabucIP() ; генерация ИНН для ИП и названия организации
;~ return
;~ ^numpad2:: KabucUR() ; генерация ИНН для ЮР и названия организации
;~ return
^numpad3:: Pasport() ; заполнение паспортных данных
return
